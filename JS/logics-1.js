...
function loadLogo(event) {
  ...
  if (file) {
    ...
    reader.onload = function (e) {
      ...
      document.getElementById("logo_status").innerText =
...
function changeSampleCount() {
  currentSampleCount = parseInt(
    document.getElementById("sample_count_select").value,
  );
  renderSampleRows();
}
...
function calculateData() {
  ...
  for (let i = 1; i <= currentSampleCount; i++) {
    const pLleno =
      parseFloat(document.getElementById(`p_lleno_${i}`).value) || 0;
    const volumen =
      parseFloat(document.getElementById(`volumen_${i}`).value) || 0;
    const pVacioVal = parseFloat(document.getElementById(`p_vacio_${i}`).value);
    const difInput = document.getElementById(`dif_${i}`);

    if (
      !isNaN(pVacioVal) &&
      document.getElementById(`p_vacio_${i}`).value.trim() !== ""
    ) {
    ...
    let dif = 0;
    if (
      document.getElementById(`volumen_${i}`).value !== "" &&
      document.getElementById(`p_lleno_${i}`).value !== ""
    ) {
      dif = volumen - pLleno;
  ...
  document.getElementById("res_desv_maxima").innerText = hasValidDesv
    ? maxDesv.toFixed(2)
    : "0.00";
}
...
function generateAndPrintReport() {
  ...
  document.getElementById("rpt_fecha").innerText =
    document.getElementById("input_fecha").value;
  document.getElementById("rpt_cliente").innerText =
    document.getElementById("input_cliente").value;
  document.getElementById("rpt_proveedor").innerText =
    document.getElementById("input_proveedor").value;
  document.getElementById("rpt_producto").innerText =
    document.getElementById("input_producto").value;
  document.getElementById("rpt_presentacion").innerText =
    document.getElementById("input_presentacion").value;
  document.getElementById("rpt_cant_botellas").innerText =
    document.getElementById("input_cant_botellas").value;
  document.getElementById("rpt_num_paletas").innerText =
    document.getElementById("input_num_paletas").value;
  document.getElementById("rpt_densidad").innerText =
    document.getElementById("input_densidad").value;
  document.getElementById("rpt_codigo").innerText =
    document.getElementById("input_codigo").value;
  document.getElementById("rpt_cod_juliano").innerText =
    document.getElementById("input_cod_juliano").value;
  document.getElementById("rpt_lote").innerText =
    document.getElementById("input_lote").value;
  document.getElementById("rpt_num_factura").innerText =
    document.getElementById("input_num_factura").value;
  document.getElementById("rpt_num_qr").innerText =
    document.getElementById("input_num_qr").value;

  const tipoBotella = document.querySelector(
    'input[name="tipo_botella"]:checked',
  ).value;
  document.getElementById("rpt_pet_check").innerText =
    tipoBotella === "PET" ? "[X]" : "[ ]";
  document.getElementById("rpt_vidrio_check").innerText =
    tipoBotella === "VIDRIO" ? "[X]" : "[ ]";
  ...
  mapCheck(
    document.getElementById("param_punto_llenado").value,
    "rpt_pj_c",
    "rpt_pj_nc",
  );
  mapCheck(
    document.getElementById("param_vidrio_frio").value,
    "rpt_vf_c",
    "rpt_vf_nc",
  );
  mapCheck(
    document.getElementById("param_superficie_regular").value,
    "rpt_sr_c",
    "rpt_sr_nc",
  );
  mapCheck(
    document.getElementById("param_punto_fragil").value,
    "rpt_pf_c",
    "rpt_pf_nc",
  );
  mapCheck(
    document.getElementById("param_dimensiones").value,
    "rpt_dim_c",
    "rpt_dim_nc",
  );
  ...
  for (let i = 1; i <= 13; i++) {
    ...
    if (
      ...
      tr.innerHTML =
        `<td>${i}</td>` + '<td class="diagonal-cell"></td>'.repeat(7);
    } else {
      tr.innerHTML = `
                        <td>${i}</td>
                        <td>${pVacio}</td>                   
  ...
  document.getElementById("rpt_tot_vol").innerText =
    document.getElementById("res_vol_promedio").innerText;
  document.getElementById("rpt_tot_dif").innerText =
    document.getElementById("res_dif_promedio").innerText;
  document.getElementById("rpt_tot_desv").innerText =
    document.getElementById("res_desv_maxima").innerText;

  document.getElementById("rpt_fp_ref").innerText =
    document.getElementById("input_fp_ref").value || "";
  document.getElementById("rpt_vol_prom_fp").innerText =
    document.getElementById("res_vol_promedio").innerText;
  document.getElementById("rpt_desv_max").innerText =
    document.getElementById("res_desv_maxima").innerText;
  document.getElementById("rpt_p_vacio_minmax").innerText =
    document.getElementById("input_p_vacio_minmax").value || "";
  document.getElementById("rpt_prof_minmax").innerText =
    document.getElementById("input_prof_llenado_minmax").value || "";
  document.getElementById("rpt_observaciones_gen").innerText =
    document.getElementById("input_observaciones_gen").value || "";
